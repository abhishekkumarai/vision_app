...
import 'dart:js_interop_unsafe'; // LOCAL PATCH: globalContext[]= (see initialize)
import 'dart:ui';
...
class Camera {
  ...
  Future<void> initialize() async {
    ...
    // LOCAL PATCH (vision_app, KAN-92): publish the live <video> so the app's
    // MediaPipe JS bridge (web/mediapipe_bridge.js) can run on-device detection
    // on it. The element is otherwise private to this plugin.
    globalContext['__flutterCameraVideo'] = videoElement;
